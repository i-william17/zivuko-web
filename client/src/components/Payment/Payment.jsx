  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5">
      <div className="flex justify-between">
        <h3 className="text-[18px] font-[600] text-[#000000a4]">Subtotal:</h3>
        <h5 className="text-[16px] font-[400] text-[#000000a4]">
          sh {orderData?.subTotalPrice}
        </h5>
      </div>
      <br />
      <div className="flex justify-between">
        <h3 className="text-[18px] font-[600] text-[#000000a4]">
          Shipping Fee:
        </h3>
        <h5 className="text-[16px] font-[400] text-[#000000a4]">
          sh {orderData?.shipping}
        </h5>
      </div>
      <br />
      <div className="flex justify-between">
        <h3 className="text-[18px] font-[600] text-[#000000a4]">Discount:</h3>
        <h5 className="text-[16px] font-[400] text-[#000000a4]">
          sh {orderData?.discountPrice}
        </h5>
      </div>
      <br />
      <div className="flex justify-between border-t pt-3">
        <h3 className="text-[18px] font-[600] text-[#000000a4]">Total:</h3>
        <h5 className="text-[18px] font-[600] text-[#000000b0]">
          sh {orderData?.totalPrice}
        </h5>
      </div>
      <br />
    </div>
